...
//http://www.iotunbox.com/advertisement/adv1.jpg
    ...
    //returns the ip address in json
    public final static String jsonurl = "http://ip.jsontest.com";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        // now lets process/Parse the json string which is in response onject.
                        String JSon_string = response.toString();
                        JSONObject emp= null;
                        try {
                            emp = new JSONObject(JSon_string);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }

                        try {
                            String empname=emp.getString("ip");
                            helloview.setText(empname);
